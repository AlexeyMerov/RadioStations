...
@HiltViewModel
class FavoritesViewModel @Inject constructor(private val categoryUseCase: CategoryUseCase) :
        ...
        viewModelScope.launch(ioContext) {
            when {
                ...
                categoryDto.items.isEmpty() -> {
                    ...
                    setState(ViewState.FavoritesLoaded)
                }
            }
        }
    }
    ...
    sealed interface ViewState : BaseViewState {
        ...
        data object FavoritesLoaded : ViewState
    }
