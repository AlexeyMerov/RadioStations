...
class SettingsStoreImpl @Inject constructor(private val userPrefs: DataStore<Preferences>) : SettingsStore {
    ...
    override fun getStringPrefsFlow(key: Preferences.Key<String>): Flow<String> = userPrefs.data.mapNotNull { it[key] }

    override fun getIntPrefsFlow(key: Preferences.Key<Int>): Flow<Int> = userPrefs.data.mapNotNull { it[key] }
