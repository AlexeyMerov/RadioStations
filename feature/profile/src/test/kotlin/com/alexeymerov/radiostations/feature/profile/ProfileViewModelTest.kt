...
class ProfileViewModelTest {
    ...
    fun getState_returnsLoadedAsFirstState() = runTest {
        viewModel.viewState.test {
            assertThat(awaitItem()).isEqualTo(ViewState.Loaded)
        }
    }
    ...
    fun getState_afterEnterEditAction_returnsEditState() = runTest {
        viewModel.viewState.test {
            ...
            assertThat(awaitItem()).isEqualTo(ViewState.InEdit)
        }
    }
    ...
    @Test
    fun countryFlow_onInit_returnsEmptyFlow() = runTest {
        val pagingData = viewModel.countryCodes.first()
    ...
    fun onAction_SearchCountry_updatesFlowWithFilteredCountries() = runTest {
        ...
        val filteredPagingData = viewModel.countryCodes.first()
    ...
    fun onAction_SaveCroppedImage_updatesUserAvatar() = runTest {
        ...
        val userDto = viewModel.userData.first()
        assertThat(userDto).isNotNull()
        userDto!!
        ...
        val updatedDto = viewModel.userData.first()
        assertThat(updatedDto).isNotNull()
        updatedDto!!
